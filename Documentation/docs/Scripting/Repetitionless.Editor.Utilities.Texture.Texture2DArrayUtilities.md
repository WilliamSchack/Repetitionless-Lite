# Editor.Utilities.Texture.Texture2DArrayUtilities
...
## CreateArrayAutoResize(Texture2D[], TextureFormat, Vector2Int, bool, bool)
...
| textures | The textures that will be in the array |
| textureFormat | The texture format of the output array |
| resolution | The resolution of the new texture array |
| transferMipmaps | If mipmaps will be transferred from the textures to the array |
| linear | If the output array will be linear |

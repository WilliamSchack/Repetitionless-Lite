...
| MaterialBlendMaskTO | <strong>IF USING NOISE MASK:</strong><br />x: BlendMaskNoiseScale<br />zw: BlendMaskNoiseOffset<br /><strong>IF USING TEXTURE MASK:</strong><br />xyzw: BlendMaskTextureTO<br /><strong>IF USING VERTEX COLOUR MASK:</strong><br />xyzw: BlendMaskVertexColour |
| MaterialBlendMaskExtraSettings | <strong>IF USING VERTEX COLOUR:</strong><br />xy: BlendMaskVertexColourThreshold |

# Variables.RepetitionlessMaterialData
...
| OcclussionAssigned | If the occlussion texture is assigned |
...
| OcclussionStrength | The occlussion strength |
...
| VariationTextureTO | The variation texture tiling offset:<br />xy: Tiling, zw: Offset |

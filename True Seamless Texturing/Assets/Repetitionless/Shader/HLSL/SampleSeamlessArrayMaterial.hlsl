#ifndef SAMPLESEAMLESSARRAYMATERIAL_INCLUDED
#define SAMPLESEAMLESSARRAYMATERIAL_INCLUDED
...
// Couldnt think of a clean way to reuse the code from the SampleSeamlessMaterialMaster function so just copying it over
// Essentially just the SampleSeamlessMaterialMaster function but using arrays and a different sampling function
void SampleSeamlessArrayMaterial(
    ...
    UnityTexture2DArray FarTextures, UnityTexture2D FarNormalMap, // Textures
    int FarArrayAssignedTextures, // Array Assigned Textures
    ...
    UnityTexture2DArray BlendTextures, UnityTexture2D BlendNormalMap, // Textures
    int BlendArrayAssignedTextures, // Array Assigned Textures
    ...
    if (materialBlendEnabled)
    {
        ...
        if (materialMask > 0)
        {
            ...
            GetSeamlessArrayMaterialColor(
                ...
                BlendTextures, BlendNormalMap,
                BlendArrayAssignedTextures,

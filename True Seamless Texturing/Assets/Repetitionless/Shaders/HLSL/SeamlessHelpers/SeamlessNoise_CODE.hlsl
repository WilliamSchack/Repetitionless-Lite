#ifndef SEAMLESSNOISE_CODE_INCLUDED
#define SEAMLESSNOISE_CODE_INCLUDED

#include "SeamlessTextureUtilities_CODE.hlsl"
...
//    sampler2D InputTexture, // Texture
//    float2 UV, // UV
//    float NoiseAngleOffset, float NoiseScale, bool RandomiseNoiseScaling, float2 NoiseScalingMinMax, // Noise
//    bool RandomiseRotation, float2 RandomiseRotationMinMax, // Noise Rotation
...
//    
//    OutputColor = SampleSeamlessTexture(InputTexture, EdgeMask, EdgeUV, TransformedUV, true);
//}

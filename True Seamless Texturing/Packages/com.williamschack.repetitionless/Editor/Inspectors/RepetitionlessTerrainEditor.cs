    ...
    public class RepetitionlessTerrainEditor : UnityEditor.Editor
    {
        ...
        private void DrawAssignedMaterialGUI()
        {
            ...
            if (_terrainLayers.Length > 4) {
                EditorGUILayout.HelpBox($"You have {_terrainLayers.Length} terrain layers set with a max of 4 layers, any layers past 4 will not be shown.\nUpgrade to Repetitionless Pro to support up to 32 terrain layers.", MessageType.Warning);
                GUILayout.Space(5);
            }
